...
3. Verify the provider, API key, base URL, and model selection, then restart Cursor before retrying.
...
1. Record the request path, model, and `API key not working` without logging secret values.
