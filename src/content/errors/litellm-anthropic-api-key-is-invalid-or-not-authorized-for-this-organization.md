---
title: "Azure OpenAI Models Authentication Broken in LiteLLM v1.84.0"
description: "fix LiteLLM Azure OpenAI auth broken / LiteLLM 1.84.0 authentication error Includes evidence for LiteLLM troubleshooting demand."
category: "LiteLLM"
technology: "LiteLLM"
error_signature: "Anthropic API key is invalid or not authorized for this organization"
common_causes:
...
related_errors:
  - "LiteLLM Azure deployment errors"
  - "LiteLLM proxy authentication failures"
updated: "2026-05-15"
...
Evidence note: Reported 2026-05-14: Azure OAI models auth broken in LiteLLM v1.84.0. Multiple users affected. Regression in a paid proxy service.
...
Start with the exact `Anthropic API key is invalid or not authorized for this organization` text and the smallest action that reproduces it.
...
Rerun the same command, editor action, or request. The fix is working when that action completes without `Anthropic API key is invalid or not authorized for this organization`.
